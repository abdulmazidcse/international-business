                ...
                @endif
                  <form role="form" action="{{ route('roles.store') }}" method="POST">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword1">Descriotion</label>
                        <input type="text" class="form-control @error('description') is-invalid @enderror" name="description" id="exampleInputPassword1" placeholder="Description here">
                      </div>  
                    </div>    
