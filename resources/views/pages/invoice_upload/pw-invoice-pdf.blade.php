			...
			<tbody>
				<tr>
					<th colspan="9" style="text-align: center; ">
						<h2 class="mb-0" style=" "><strong>Packing & Weight Invoice</strong></h2>
					</th>
				</tr>
				<tr>
					...
					<th colspan="3" rowspan="4" style="text-align: right !important; ">
				...
				<tr>
					...
					<th colspan="2" style="width: 30% !important;text-align: right !important">
						{{ $orderlist->commercialInvoice->exp_no }}
					</th>
				</tr>
				<tr>
				...
				<tr>
					...
					<th colspan="6" style="width: 30% !important;text-align: right !important">
				...
				<tr>
					<td colspan="8" style="text-align: center;"><strong> GRAND TOTAL </strong></td>
					<td style="text-align: center;"><strong> ${{ $totalValueUsdWithFreight}}</strong></td>
				</tr>
				<tr>
					<td colspan="9" style="text-align: center; text-transform: uppercase"><strong> Total In Words: USD {{ numberToWord($totalValueUsdWithFreight) }} </strong></td>
				</tr>
				<tr>
