...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Angikarnama</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Angikarnama list</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Angikarnama list</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td >
                                                      <div class="btn-group btn-group-sm"> 
                                                        <a title="Print Angikarnama" target="_blank" href="{{ url('angikarnama-print/' . $row->id) }}" class="btn btn-success"><i class="fas fa-print"></i></a> 
