                                    ...
                                    <div class="col-sm-6">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="myeditorinstance" value="{{ old('terms_and_conditions') }}"
                                                    class="form-control @error('terms_and_conditions') is-invalid @enderror" name="terms_and_conditions"
                                                    placeholder="Enter terms & conditions "></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="payment_terms">Payment Terms</label>

                                                <textarea id="payment_terms" value="{{ old('payment_terms') }}"
                                                    class="form-control @error('payment_terms') is-invalid @enderror" name="payment_terms"
                                                    placeholder="Enter terms & conditions "></textarea>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <select name="country_id" id="country"
                                                    ...
                                                    @foreach ($country as $row)
                                                        <option value="{{ $row->id }}"
                                                            {{ old('country_id') == $row->id ? 'selected' : '' }}>
                                                            {{ $row->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select name="mode_of_carrying" id="mode_of_carrying"
                                                    class="form-control @error('mode_of_carrying') is-invalid @enderror">
                                                    <option value="">Select Mode of Carrying</option>
                                                    @foreach ($modes as $row)
                                                        <option value="{{ $row->id }}"
                                                            {{ old('mode_of_carrying') == $row->id ? 'selected' : '' }}>
                                                            {{ $row->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select name="port_discharge" id="port_discharge"
                                                    class="form-control @error('port_discharge') is-invalid @enderror">
                                                    <option value="">Select Discharged </option>
                                                    @foreach ($discharged as $row)
                                                        <option value="{{ $row->id }}"
                                                            {{ old('port_discharge') == $row->id ? 'selected' : '' }}>
                                                            {{ $row->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select name="final_destination" id="final_destination"
                                                    class="form-control @error('final_destination') is-invalid @enderror">
                                                    <option value="">Select Destination </option>
                                                    @foreach ($destinations as $row)
                                                        <option value="{{ $row->id }}"
                                                            {{ old('final_destination') == $row->id ? 'selected' : '' }}>
                                                            {{ $row->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select name="loading_place" id="loading_place"
                                                    class="form-control @error('final_destination') is-invalid @enderror">
                                                    <option value="">Select Loading Place </option>
                                                    @foreach ($loading_places as $row)
                                                        <option value="{{ $row->id }}"
                                                            {{ old('loading_place') == $row->id ? 'selected' : '' }}>
                                                            {{ $row->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
