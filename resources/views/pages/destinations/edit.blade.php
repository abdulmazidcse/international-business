        ...
        <div class="card card-default">
            ...
            <div class="card-body">
              <div class="row">
                ...
                @endif
                  <form role="form" action="{{ route('destinations.update', $destinations->id) }}" method="POST">
                  @method('PUT') 
                    @csrf
                    <div class="card-body">
                      <div class="form-group">
                        <label for="name">Destination Address</label>
                        <input type="text" value="{{$destinations->name}}" id="name" class="form-control @error('name') is-invalid @enderror" name="name"  placeholder="Enter Destination Address"> 
                      </div>  
                    </div>    
