            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Mode of Carrying list</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                        ...
                                        <table id="example2" class="table table-bordered table-hover dataTable dtr-inline"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_desc" tabindex="0" aria-controls="example2"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Rendering engine: activate to sort column ascending"
                                                        aria-sort="descending">Mode of Carrying</th> 
                                            ...
                                            <tbody>
                                              ...
                                              @foreach ($modes as $mode)
                                                <tr role="row" class="odd">
                                                    <td class="sorting_1" tabindex="0">{{ $mode->id }} </td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th rowspan="1" colspan="1">Mode of Carrying</th> 
